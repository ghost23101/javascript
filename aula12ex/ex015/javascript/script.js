    ...
    if (fano.value.length == 0 || Number(fano.value) > ano){
        ...
        if (fsex[0].checked){
            ...
            if (idade >=0 && idade < 10){
                ...
                //jovem
                img.setAttribute('src', 'img/foto-homem-jovem.png')
            } else if (idade < 50){
                //adulto
                img.setAttribute('src', 'img/foto-homem-adulto.png')
            } else{
                // idoso
                img.setAttribute('src', 'img/foto-idoso.png')
            }
            ...
            if (idade >=0 && idade < 10){
                ...
                //jovem
                img.setAttribute('src', 'img/foto-mulher-jovem.png')
            } else if (idade < 50){
                //adulto
                img.setAttribute('src', 'img/foto-mulher-adulta.png')
            } else{
                // idoso
                img.setAttribute('src', 'img/foto-idosa.png.png')
            }
        }
